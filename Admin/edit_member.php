					...
					<div class="col-lg-5">
						<div class="well">
							...
							<div class="form-group">
								<input type="text" class="form-control" name="inputusername" id="inputusername" value="<?php echo $m_username; ?>" placeholder="Username" required>
							</div>
							<div class="form-group">
								<input type="password" class="form-control" name="inputpassword" id="inputpassword" value="<?php echo $m_password; ?>" placeholder="Password" required>
							</div>
...
if (isset($_POST["submit"])) {
	...
	mysqli_query($link, "update admin_login set username='$_POST[inputusername]',password='$_POST[inputpassword]' where id='$id'");
