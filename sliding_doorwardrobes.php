...
<title>Sliding Door Wardrobes</title>
<base  />
...
<!-- /sys-notification -->
    <div class="dj">
     			...
     			<ul class="breadcrumb">
      				...
      				<li><a href="sliding_doorwardrobes.php?route=product/category&amp;path=24" style="color:white">Sliding Door Wardrobes</a></li>
     			</ul>
    		<div class="row">
                  ...
                  <div id="products" class="product-grid filter_data"> 
					<div class="products-block">
				     ...
				     <?php
						...
						$res = mysqli_query($link,"select * from {$statement} WHERE product_secondary_category='slidingdoorw' LIMIT {$startpoint} , {$limit}");
