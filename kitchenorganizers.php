...
<!-- /sys-notification -->
    <div class="dj">
     			...
     			<ul class="breadcrumb">
      				...
      				<li><a href="kitchenware.php?route=product/category&amp;path=24" style="color:white">KitchenWare</a></li>
      				<li><a href="kitchenorganizers.php?route=product/category&amp;path=24" style="color:white">Kitchen Organizers</a></li>
     			</ul>
    		<div class="row">
                  ...
                  <div id="products" class="product-grid filter_data"> 
					<div class="products-block">
				     ...
				     <?php
						...
						$res = mysqli_query($link,"select * from {$statement} WHERE product_secondary_category='kitchenorganizers' LIMIT {$startpoint} , {$limit}");
