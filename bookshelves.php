		...
		<div id="page">
			...
			<div class="dj">
				...
				<ul class="breadcrumb">
					...
					<li><a href="bookshelves.php?route=product/category&amp;path=24" style="color:white">Book Shelves</a></li>
				</ul>
				<div class="row">
									...
									<div id="products" class="product-grid filter_data">
										<div class="products-block">
											<div class="row products-row">
												...
												$res = mysqli_query($link, "select * from {$statement} WHERE product_secondary_category='bookshelves' LIMIT {$startpoint} , {$limit}");
