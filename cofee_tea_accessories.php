...
<title>Cofee & Tea Accessories</title>
<base  />
...
<!-- /sys-notification -->
    <div class="dj">
     			...
     			<ul class="breadcrumb">
      				...
      				<li><a href="tableware.php?route=product/category&amp;path=24" style="color:white">TableWare</a></li>
      				<li><a href="cofee_tea_accessories.php?route=product/category&amp;path=24" style="color:white">Cofee & Tea Accessories</a></li>
     			</ul>
    		<div class="row">
                  ...
                  <div id="products" class="product-grid filter_data"> 
					<div class="products-block">
				     ...
				     <?php
						...
						$res = mysqli_query($link,"select * from {$statement} WHERE product_secondary_category='cofeeteaacc' LIMIT {$startpoint} , {$limit}");
