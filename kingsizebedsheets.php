...
<title>King Size Bed Sheets</title>
<base  />
...
<!-- /sys-notification -->
    <div class="dj">
     			...
     			<ul class="breadcrumb">
      				...
      				<li><a href="allfurniture.php?route=product/category&amp;path=24" style="color:white">Home Furnishings</a></li>
      				<li><a href="kingsizebedsheets.php?route=product/category&amp;path=24" style="color:white">King Size Bed Sheets</a></li>
     			</ul>
    		<div class="row">
                  ...
                  <div id="products" class="product-grid filter_data"> 
					<div class="products-block">
				     ...
				     <?php
						...
						$res = mysqli_query($link,"select * from {$statement} WHERE product_secondary_category='kingsizebedsheets' LIMIT {$startpoint} , {$limit}");
