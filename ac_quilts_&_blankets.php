...
<title>A/C Quilts & Blankets</title>
<base  />
...
<!-- /sys-notification -->
    <div class="dj">
     			...
     			<ul class="breadcrumb">
      				...
      				<li><a href="homefurnishings.php?route=product/category&amp;path=24" style="color:white">Home Furnishings</a></li>
      				<li><a href="ac_quilts_&_blankets.php?route=product/category&amp;path=24" style="color:white">A/C Quilts & Blankets</a></li>
     			</ul>
    		<div class="row">
                  ...
                  <div id="products" class="product-grid filter_data"> 
					<div class="products-block">
				     ...
				     <?php
						...
						$res = mysqli_query($link,"select * from {$statement} WHERE product_secondary_category='a/c_quiltsblankets' LIMIT {$startpoint} , {$limit}");
