...
<title>6 Seater Dining Sets</title>
<base  />
...
<!-- /sys-notification -->
    <div class="dj">
     			...
     			<ul class="breadcrumb">
      				...
      				<li><a href="6seaterdiningsets.php?route=product/category&amp;path=24" style="color:white">6 Seater Dining Sets</a></li>
     			</ul>
    		<div class="row">
                  ...
                  <div id="products" class="product-grid filter_data"> 
					<div class="products-block">
				     ...
				     <?php
						...
						$res = mysqli_query($link,"select * from {$statement} WHERE product_secondary_category='6seater' LIMIT {$startpoint} , {$limit}");
