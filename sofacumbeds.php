...
<!-- /sys-notification -->
    <div class="dj">
     			...
     			<ul class="breadcrumb">
      				...
      				<li><a href="sofacumbeds.php?route=product/category&amp;path=24" style="color:white">Sofa Cum Beds</a></li>
     			</ul>
    		<div class="row">
                  ...
                  <div id="products" class="product-grid filter_data"> 
					<div class="products-block">
				     ...
				     <?php
						...
						$res = mysqli_query($link,"select * from {$statement} WHERE product_secondary_category='sofacumbeds' LIMIT {$startpoint} , {$limit}");
						//$res = mysqli_query($link,"SELECT * FROM {$statement} WHERE `product_secondary_category`='sofacumbeds';");
